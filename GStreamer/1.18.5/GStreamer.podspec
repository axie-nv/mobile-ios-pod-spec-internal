Pod::Spec.new do |s|
    ...
    s.description  = <<-DESC
    GStreamer framework made from tag 1.18.5 with patched core audio part (for detailed info see NVM-1373).
    DESC
    ...
    s.source       = { :http => "https://nativevoiceai.jfrog.io/artifactory/CocoaPods/GStreamer/1.18.5/GStreamer.framework.zip" }
