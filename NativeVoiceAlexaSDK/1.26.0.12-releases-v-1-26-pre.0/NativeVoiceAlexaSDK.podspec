Pod::Spec.new do |s|
    ...
    s.version      = "1.26.0.12-releases-v-1-26-pre.0"
    ...
    s.source                = { :http => "https://nativevoiceai.jfrog.io/artifactory/CocoaPods/ai/nativevoice/NativeVoiceAlexaSDK/1.26.0.12-releases-v-1-26-pre.0/NativeVoiceAlexaSDK.xcframework.zip" }
