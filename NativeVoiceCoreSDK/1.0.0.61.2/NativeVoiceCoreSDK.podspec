Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://nativevoiceai.jfrog.io/artifactory/CocoaPods/ai/nativevoice/NativeVoiceCoreSDK/1.0.0.61.2/NativeVoiceCoreSDK.xcframework.zip" }
