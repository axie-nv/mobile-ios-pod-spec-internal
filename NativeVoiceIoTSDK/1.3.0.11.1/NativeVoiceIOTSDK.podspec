Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://nativevoiceai.jfrog.io/artifactory/CocoaPods/ai/nativevoice/NativeVoiceIOTSDK/1.3.0.11.1/NativeVoiceIOTSDK.xcframework.zip" }
