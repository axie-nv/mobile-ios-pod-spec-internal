Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://nativevoiceai.jfrog.io/artifactory/CocoaPods/ai/nativevoice/NativeVoiceIoTSDK/1.3.0.29.1/NativeVoiceIoTSDK.xcframework.zip" }
