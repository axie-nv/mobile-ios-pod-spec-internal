Pod::Spec.new do |s|
    ...
    s.platform = :ios
    s.source       = { :http => "https://nativevoiceai.jfrog.io/artifactory/CocoaPods/ai/nativevoice/NativeVoiceUIComponents/Microphone/0.0.0.28/NativeVoiceUIComponentMicrophone.xcframework.zip" }
