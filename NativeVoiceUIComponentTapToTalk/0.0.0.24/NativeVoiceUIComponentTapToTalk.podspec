Pod::Spec.new do |s|
    ...
    s.platform = :ios
    s.source       = { :http => "https://nativevoiceai.jfrog.io/artifactory/CocoaPods/ai/nativevoice/NativeVoiceUIComponents/TapToTalk/0.0.0.24/NativeVoiceUIComponentTapToTalk.xcframework.zip" }
